<!DOCTYPE html>
<html>
<title>W3.CSS app launch Template</title>
...
<header class="w3-display-container w3-center">
  <button class="w3-btn-block w3-green w3-hide-large w3-hide-medium">Download <i class="fa fa-android"></i> <i class="fa fa-apple"></i> <i class="fa fa-windows"></i></button>
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="http://www.w3schools.com/w3images/app.jpg" alt="Image 1" width="1500" height="1126" style="min-width:500px">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Take photos with our app</h1>
        <hr class="w3-opacity">
        <p>Super simple installment: free of charge</p>
        <p><button class="w3-btn-block w3-green w3-round">Download <i class="fa fa-android"></i> <i class="fa fa-apple"></i> <i class="fa fa-windows"></i></button></p>
      </div>
    </div>
  </div>
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="http://www.w3schools.com/w3images/app2.jpg" alt="Image 2" width="1500" height="1126" style="min-width:500px">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge w3-text-red"><b>CLICK!</b> Fast and Easy</h1>
        <hr class="w3-opacity">
        <p>Choose from thousands of features</p>
        <p><button class="w3-btn-block w3-red w3-round">Download <i class="fa fa-android"></i> <i class="fa fa-apple"></i> <i class="fa fa-windows"></i></button></p>
      </div>
    </div>
  </div>
  <div class="mySlides w3-animate-opacity">
    <img class="w3-image" src="http://www.w3schools.com/w3images/app4.jpg" alt="Image 3" width="1500" height="1126" style="min-width:500px">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">Smart Design</h1>
        <hr class="w3-opacity">
        <p>Customize photos as you go</p>
        <p><button class="w3-btn-block w3-indigo w3-round">Download <i class="fa fa-android"></i> <i class="fa fa-apple"></i> <i class="fa fa-windows"></i></button></p>
      </div>
    </div>
  </div>
  <a class="w3-btn w3-black w3-padding w3-display-right w3-margin-right w3-round w3-hide-small w3-hover-light-grey" onclick="plusDivs(1)">Take Tour ❯</a>
  <a class="w3-btn-block w3-black w3-padding w3-hide-large w3-hide-medium" onclick="plusDivs(1)">Take Tour ❯</a>
</header>
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    <div class="w3-col l8 m6">
      ...
      <button class="w3-btn w3-light-grey w3-padding-large w3-margin-top w3-hide-small">
    ...
    <div class="w3-col l4 m6">
      <img src="http://www.w3schools.com/w3images/img_app.jpg" class="w3-image w3-right w3-hide-small" width="335" height="471">
      <div class="w3-center w3-hide-large w3-hide-medium">
        <button class="w3-btn-block w3-light-grey w3-padding-large">
          <i class="fa fa-download"></i> Download Application
        </button>
        <img src="http://www.w3schools.com/w3images/img_app.jpg" class="w3-image w3-margin-top" width="335" height="471">
      </div>
    </div>
  </div>
</div>
...
<div class="w3-padding-64 w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col l4 m6">
      <img class="w3-image w3-round-large w3-hide-small w3-grayscale" src="http://www.w3schools.com/w3images/app5.jpg" alt="Architecture" width="335" height="471">
    </div>
    <div class="w3-col l8 m6">
...
<!-- Pricing Section -->
<div class="w3-padding-64 w3-center w3-black">
    ...
    <div class="w3-half w3-section">
      <ul class="w3-ul w3-white">
        ...
        <li class="w3-light-grey w3-padding-24">
          <button class="w3-btn w3-black w3-padding-large">Sign Up <i class="fa fa-sign-in"></i></button>
        </li>
      </ul>
    </div>
    <div class="w3-half w3-section">
...
<footer class="w3-container w3-padding-32 w3-light-grey w3-center w3-xlarge">
  ...
  <p class="w3-medium">Powered by <a href="." target="_self" class="w3-hover-text-green"> at expertcodedesign</a></p>
</footer>
