<!DOCTYPE html>
<html>
<title>W3.CSS Hotel Template</title>
...
<ul class="w3-navbar w3-white w3-large">
  <li><a href="#" class="w3-red"><i class="fa fa-bed w3-margin-right"></i>Logo</a></li>
...
<header class="w3-display-container w3-content" style="max-width:1500px;">
  <img class="w3-image" src="http://www.w3schools.com/w3images/hotel.jpg" alt="The Hotel" style="min-width:1000px" width="1500" height="800">
...
<div class="w3-content" style="max-width:1532px;">
  ...
  <div class="w3-row-padding w3-padding-16">
    <div class="w3-third w3-margin-bottom">
      <img src="http://www.w3schools.com/w3images/room_single.jpg" alt="Norway" style="width:100%">
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="http://www.w3schools.com/w3images/room_double.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Double Room</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <img src="http://www.w3schools.com/w3images/room_deluxe.jpg" alt="Norway" style="width:100%">
      <div class="w3-container w3-white">
        <h3>Deluxe Room</h3>
  ...
  <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
    <div class="w3-half w3-margin-bottom">
      <div class="w3-display-container">
        <img src="http://www.w3schools.com/w3images/cinqueterre.jpg" alt="Cinque Terre" style="width:100%">
    ...
    <div class="w3-half">
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="http://www.w3schools.com/w3images/newyork2.jpg" alt="New York" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">New York</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="http://www.w3schools.com/w3images/sanfran.jpg" alt="San Francisco" style="width:100%">
      ...
      <div class="w3-row-padding" style="margin:0 -16px">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="http://www.w3schools.com/w3images/pisa.jpg" alt="Pisa" style="width:100%">
            <span class="w3-display-bottomleft w3-padding">Pisa</span>
          </div>
        </div>
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            <img src="http://www.w3schools.com/w3images/paris.jpg" alt="Paris" style="width:100%">
...
<footer class="w3-padding-32 w3-black w3-center w3-margin-top">
  ...
  <p>Powered by <a href="." target="_self" class="w3-hover-text-green"> at expertcodedesign</a></p>
</footer>
