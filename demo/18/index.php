...
<nav class="w3-sidenav w3-center w3-small w3-hide-small">
  ...
  <img src="http://www.w3schools.com/w3images/avatar_smoke.jpg" style="width:100%">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" id="home">
    ...
    <img src="http://www.w3schools.com/w3images/man_smoke.jpg" alt="boy" class="w3-image" width="992" height="1108">
  </header>
  ...
  <footer class="w3-content w3-padding-64 w3-text-grey w3-xlarge">
    ...
    <p class="w3-medium">Powered by <a href="."  class="w3-hover-text-green" target="_self" title=" development" > at expertcodedesign</a></p>
  <!-- End footer -->
  </footer>
