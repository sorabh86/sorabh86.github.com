<!DOCTYPE html>
<html>
<title>W3.CSS marketing Template</title>
...
<div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
  ...
  <div class="w3-row-padding" id="about">
    ...
    <div class="w3-third w3-margin-bottom">
      <div class="w3-card-4">
        <img src="http://www.w3schools.com/w3images/team1.jpg" alt="John" style="width:100%">
        <div class="w3-container">
          <h3>Jane Doe</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <div class="w3-card-4">
        <img src="http://www.w3schools.com/w3images/team2.jpg" alt="Mike" style="width:100%">
        <div class="w3-container">
          <h3>Mike Ross</h3>
    ...
    <div class="w3-third w3-margin-bottom">
      <div class="w3-card-4">
        <img src="http://www.w3schools.com/w3images/team3.jpg" alt="Jane" style="width:100%">
        <div class="w3-container">
          <h3>John Doe</h3>
