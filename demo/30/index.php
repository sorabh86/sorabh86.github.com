<!DOCTYPE html>
<html>
<title>W3.CSS  Marketing Template II </title>
...
<div class="w3-top">
 <ul class="w3-navbar w3-theme-d2 w3-left-align">
  ...
  <li class="w3-hide-small"><a href="#team" class="w3-hover-white">Team</a></li>
...
<div class="w3-display-container w3-animate-opacity">
  <img src="http://www.w3schools.com/w3images/sailboat.jpg" alt="boat" style="width:100%;min-height:350px;max-height:600px;">
  <div class="w3-container w3-display-bottomleft w3-margin-bottom">  
    <button onclick="document.getElementById('id01').style.display='block'" class="w3-btn w3-xlarge w3-theme w3-hover-teal" title="visit expertcodedesigninfo.com">Read More</button>
  </div>
</div>
...
<div id="id01" class="w3-modal">
  <div class="w3-modal-content w3-card-8 w3-animate-top">
    ...
    <div class="w3-container">
      ...
      <p>Go to our <a class="w3-btn" href=".">Tutorials</a> to learn more!</p>
    </div>
...
<div class="w3-quarter">
  <img src="http://www.w3schools.com/w3images/avatar.jpg" alt="Boss" style="width:45%" class="w3-circle w3-hover-opacity">
  <h3>Johnny Walker</h3>
  <p>Web Designer</p>
</div>
...
<div class="w3-card-2 w3-white">
  <img src="http://www.w3schools.com/w3images/fjords.jpg" alt="Vernazza" style="width:100%">
  <div class="w3-container">
  <h3>Customer 1</h3>
  <h4>Trade</h4>
  <p>Blablabla</p>
...
<div class="w3-quarter">
<div class="w3-card-2 w3-white">
  <img src="http://www.w3schools.com/w3images/lights.jpg" alt="Cinque Terre" style="width:100%">
  <div class="w3-container">
  <h3>Customer 2</h3>
  <h4>Trade</h4>
  <p>Blablabla</p>
...
<div class="w3-quarter">
<div class="w3-card-2 w3-white">
  <img src="http://www.w3schools.com/w3images/mountains.jpg" alt="Monterosso" style="width:100%">
  <div class="w3-container">
  <h3>Customer 3</h3>
  <h4>Trade</h4>
  <p>Blablabla</p>
...
<footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
  ...
  <p>Powered by <a href="." target="_self"> at expertcodedesign</a></p>
