<!DOCTYPE html>
<html>
<title>W3.CSS pizza Template</title>
...
.bgimg {
    ...
    background-image: url("http://www.w3schools.com/w3images/pizza.jpg");
    min-height: 90%;
}
</style>
<body>
...
<div class="w3-top w3-hide-small">
  <ul class="w3-navbar w3-xlarge w3-black w3-opacity w3-hover-opacity-off" id="myNavbar">
    <li><a href="#">HOME</a></li>
...
<div class="w3-container w3-padding-64 w3-red w3-grayscale w3-xlarge" id="about">
  <div class="w3-content">
    ...
    <p><strong>The Chef?</strong> Mr. Italiano himself<img src="http://www.w3schools.com/w3images/chef.jpg" style="width:150px" class="w3-circle w3-right" alt="Chef"></p>
    <p>We are proud of our interiors.</p>
    <img src="http://www.w3schools.com/w3images/onepage_restaurant.jpg" style="width:100%" class="w3-margin-top w3-margin-bottom" alt="Restaurant">
...
<footer class="w3-center w3-black w3-padding-48 w3-xxlarge">
  <p>Powered by <a href="." title="W3.CSS" target="_self" class="w3-hover-text-green"> at expertcodedesign</a></p>
</footer>
