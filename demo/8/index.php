...
<div class="w3-content" style="max-width:1600px">
  ...
  <header class="w3-display-container w3-wide" id="home">
    <img class="w3-image" src="http://www.w3schools.com/w3images/jane.jpg" alt="Fashion Blog" width="1600" height="1060">
  ...
  <div class="w3-row w3-padding w3-border">
    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="http://www.w3schools.com/w3images/girl_hat.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-12">
          ...
          <div class="w3-row w3-padding-bottom" id="demo1" style="display:none">
            <hr>
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/avatar_smoke.jpg" style="width:90px;">
              </div>
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="http://www.w3schools.com/w3images/man_hat.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-12">
          ...
          <div id="demo2" style="display:none">
            <div class="w3-row">
              <hr>
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/girl_train.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-padding-bottom">
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/girl.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
      ...
      <div class="w3-container w3-white w3-margin w3-padding-large">
        ...
        <div class="w3-justify">
          <img src="http://www.w3schools.com/w3images/runway.jpg" alt="Runway" style="width:100%" class="w3-padding-12">
          ...
          <div id="demo3" style="display:none">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/girl_mountain.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-margin-bottom">
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/boy.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
            ...
            <div class="w3-row w3-padding-bottom">
              <div class="w3-col l2 m3">
                <img src="http://www.w3schools.com/w3images/girl_hood.jpg" style="width:90px;">
              </div>
              <div class="w3-col l10 m9">
    ...
    <div class="w3-col l4">
      ...
      <div class="w3-white w3-margin">
        <img src="http://www.w3schools.com/w3images/avatar_girl2.jpg" alt="Jane" style="width:100%" class="w3-grayscale">
      ...
      <div class="w3-white w3-margin">
        ...
        <ul class="w3-ul w3-hoverable w3-white">
          <li class="w3-padding-16">
            <img src="http://www.w3schools.com/w3images/avatar_smoke.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Denim</span>
            <br>
            <span>Sed mattis nunc</span>
          </li>
          <li class="w3-padding-16">
            <img src="http://www.w3schools.com/w3images/bandmember.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Sweaters</span>
            <br>
            <span>Praes tinci sed</span>
          </li>
          <li class="w3-padding-16">
            <img src="http://www.w3schools.com/w3images/workshop.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
            <span class="w3-large">Workshop</span>
            <br>
            <span>Ultricies congue</span>
          </li>
          <li class="w3-padding-16">
            <img src="http://www.w3schools.com/w3images/avatar_smoke.jpg" alt="Image" class="w3-left w3-margin-right w3-sepia" style="width:50px">
      ...
      <div class="w3-white w3-margin">
        ...
        <div class="w3-row-padding w3-white">
          <div class="w3-col s6">
            <p><img src="http://www.w3schools.com/w3images/jeans.jpg" alt="Jeans" style="width:100%"></p>
            <p><img src="http://www.w3schools.com/w3images/team1.jpg" alt="Jeans" style="width:100%"></p>
          </div>
          <div class="w3-col s6">
            <p><img src="http://www.w3schools.com/w3images/avatar_hat.jpg" alt="Men in Hats" style="width:100%" class="w3-grayscale"></p>
            <p><img src="http://www.w3schools.com/w3images/team4.jpg" alt="Jeans" style="width:100%"></p>
         </div>
        </div>
      </div>
      <hr>
...
<footer class="w3-container w3-dark-grey w3-padding-32 w3-padding-xlarge">
  ...
  <p>Powered by <a href="." target="_self" title=" development"> at expertcodedesign</a></p>
</footer>
